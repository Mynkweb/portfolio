...
use PHPMailer;
	if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        <br> However, you can write to me at mayank.hjp@gmail.com</p>
          </div>
        </div></div>
        "; 
		...
		$mail->SMTPAuth = true;
		$mail->Username = "1nt19ec027.ashutosh@nmit.ac.in";
		$mail->Password = "Ashutosh@2001";
		$mail->SMTPSecure = false;
		$mail->SMTPAutoTLS = false;
		
		$mail->setFrom("$email","The Staging Co");

		$mail->addAddress('ashutoshsaksaksham22@gmail.com');
		$mail->addAddress('1nt19ec027.ashutosh@nmit.ac.in');
		
		
        	$headers    =   'MIME-Version: 1.0' . "\r\n";

                    //  Additional headers
        $headers    .=  "From: The Staging Co <1nt19ec027.ashutosh@nmit.ac.in>\r\n";
